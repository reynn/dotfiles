...
Plug 'https://github.com/terryma/vim-multiple-cursors'  " Multiple cursors in Vim
...
" Plugins: Text Motions/Editing

Plug 'https://github.com/bkad/CamelCaseMotion'          " Move through words by camelCase instead of full word
