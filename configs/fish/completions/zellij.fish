...
complete -c zellij -n "__fish_seen_subcommand_from options" -l simplified-ui -d 'Allow plugins to use a more simplified layout that is compatible with more fonts (true or false)'
...
complete -c zellij -n "__fish_seen_subcommand_from options" -l mouse-mode -d 'Set the handling of mouse events (true or false) Can be temporarily bypassed by the [SHIFT] key'
complete -c zellij -n "__fish_seen_subcommand_from options" -l pane-frames -d 'Set display of the pane frames (true or false)'
...
complete -c zellij -n "__fish_seen_subcommand_from setup" -l dump-layout -d 'Dump the specified layout file to stdout'
...
complete -c zellij -n "__fish_seen_subcommand_from attach" -l index -d 'Number of the session index in the active sessions ordered creation date'
...
complete -c zellij -n "__fish_seen_subcommand_from attach" -f -a "options" -d 'Change the behaviour of zellij'
complete -c zellij -n "__fish_seen_subcommand_from attach" -f -a "help" -d 'Prints this message or the help of the given subcommand(s)'
complete -c zellij -n "__fish_seen_subcommand_from options" -l simplified-ui -d 'Allow plugins to use a more simplified layout that is compatible with more fonts (true or false)'
complete -c zellij -n "__fish_seen_subcommand_from options" -l theme -d 'Set the default theme'
complete -c zellij -n "__fish_seen_subcommand_from options" -l default-mode -d 'Set the default mode'
complete -c zellij -n "__fish_seen_subcommand_from options" -l default-shell -d 'Set the default shell'
...
complete -c zellij -n "__fish_seen_subcommand_from kill-session" -s h -l help -d 'Prints help information'
complete -c zellij -n "__fish_seen_subcommand_from kill-session" -s V -l version -d 'Prints version information'
complete -c zellij -n "__fish_seen_subcommand_from kill-all-sessions" -s y -l yes -d 'Automatic yes to prompts'
complete -c zellij -n "__fish_seen_subcommand_from kill-all-sessions" -s h -l help -d 'Prints help information'
complete -c zellij -n "__fish_seen_subcommand_from kill-all-sessions" -s V -l version -d 'Prints version information'
complete -c zellij -n "__fish_seen_subcommand_from help" -s h -l help -d 'Prints help information'
complete -c zellij -n "__fish_seen_subcommand_from help" -s V -l version -d 'Prints version information'
