...
function color_schemes.update -d "Read the latest from the colors.list file and update color scheme folders"
    ...
    if not test -d $color_scheme_folder
        log.info "Cloning color scheme repo to $color_scheme_folder"
