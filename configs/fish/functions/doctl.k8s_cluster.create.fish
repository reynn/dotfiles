...
function doctl.k8s_cluster.create -d 'Create a Kubernetes cluster in DigitalOcean'
    ...
    log.debug -l 'cluster_name' "$cluster_name"
    log.debug -l 'min_size' "$min_size"
    log.debug -l 'max_size' "$max_size"
    log.debug -l 'node_type' "$node_type"
    log.debug -l 'auto_scale' "$auto_scale"
    log.debug -l 'one_clicks' "$one_clicks"
    log.debug -l 'k8s_version' "$k8s_version"
    log.debug -l 'do_region' "$do_region"
