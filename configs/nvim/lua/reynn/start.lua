...
local function setup_keys()
  ...
  map(0, 'n', 'j', '<cmd>lua require("reynn.start").handle_j()<cr>', {noremap = true, silent = true})
  map(0, 'n', 'k', '<cmd>lua require("reynn.start").handle_k()<cr>', {noremap = true, silent = true})
  map(0, 'n', '<cr>', '<cmd>lua require("reynn.start").handle_cr()<cr>', {noremap = true, silent = true})
